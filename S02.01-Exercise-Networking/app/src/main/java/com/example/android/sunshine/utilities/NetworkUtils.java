...
public final class NetworkUtils {
    ...
    /**
     * Builds the URL used to talk to the weather server using a location. This location is based on the query
     * capabilities of the weather provider that we are using.
     *
