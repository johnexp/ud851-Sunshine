...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
     ...
     * update the contents of the ViewHolder to display the weather details for this particular position, using the
     * "position" argument that is conveniently passed into us.
     *
     * @param forecastAdapterViewHolder The ViewHolder which should be updated to represent the contents of the item at
    ...
    /**
     * This method is used to set the weather forecast on a ForecastAdapter if we've already created one. This is handy
     * when we get new data from the web but don't want to create a new ForecastAdapter to display it.
     *
